...
We now define a mediator variable $M_{i}$, drawn from $M$, which represents a continuous measure of whether the 
...
\begin{itemize}[noitemsep,topsep=0pt]
	...
	\item $\mathbb{E}[Y(1,M(0)) - Y(0,M(0))]$ --- The \textit{total direct effect}
	is the average causal effect that receiving treatment has on the outcome, keeping the level of the mediator constant 
...
\begin{equation}
\begin{aligned}
	\mathbb{E}[Y(1,M(1))] - \mathbb{E}[Y_{i}(0,M(0))] = 
	\{\mathbb{E}[Y(1,M(0))] - \mathbb{E}[Y_{i}(0,M(0))]\}\\ 
	+ \{\mathbb{E}[Y(1,M(1))] - \mathbb{E}[Y(1,M(0))]\}\\
	= \{\mathbb{E}[Y(1,M(0))] - \mathbb{E}[Y(0,M(0))]\}
...
auxilliary assumptions~\citep{imaietal2013}. 
...
situation in which post-treatment confounder does not exist but the cross-world independence assumption is still not
true. 
