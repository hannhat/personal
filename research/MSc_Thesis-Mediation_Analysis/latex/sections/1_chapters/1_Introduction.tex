...
effects, requires significantly weaker assumptions. Interventional effects estimate the 
effect of joint interventions on the treatment and the mediator that set the level of the mediator to a 
...
been seen as an important task because most mediation analyses of practical interest contain more than
...
effects~\citep{pearl2001}.~\cite{pearl2001} claims that descriptive effects concern the action of
...
whether this combination reduces blood clots regardless of the causal pathways at work.

Given that interventional effects are easier to identify, they have recently
...
effect into path-specific effects, has also seemed to influence the development of recent
...
by~\cite{vanderweelerobinson2014} is of considerable practical importance. These effects are developed
for problems where the treatment variable is considered to be non-manipulable
...
``treatment''. Such effects have been productively developed in the health disparities
literature~\citep{jacksonvanderweele2018,jackson2021}. I relate the formal framework I use for 
natural and interventional effects to these effects and use the results of~\cite{jacksonvanderweele2018}
