...
\setcounter{tocdepth}{2} % Chapter, section, and subsection names (only Natural Effects/Interventional Effects currently use subsections)
...
\include{sections/1_chapters/2_Literature_Review}
\include{sections/1_chapters/3_Preliminaries}
\include{sections/1_chapters/4_Natural_Effects}
\include{sections/1_chapters/5_Interventional_Effects}
\include{sections/1_chapters/6_Application}
